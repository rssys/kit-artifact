...
*📝Note: We provided the pre-built kernel and VM images for your convinience, since building them is time-consuming and generally requires considerable efforts in terms of setting up compatible compiler toolchain. The kernel building is done under a Ubuntu 16.04 docker image.*
